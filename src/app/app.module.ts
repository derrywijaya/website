...
import { ResearchNewsframingComponent } from './components/pages/research-newsframing/research-newsframing.component';
import { ResearchDetailsComponent } from './components/pages/research-details/research-details.component';
...
@NgModule({
  declarations: [
    ...
    CourseDetailsTUNLComponent,
    ResearchsComponent,
    ResearchNewsframingComponent,
